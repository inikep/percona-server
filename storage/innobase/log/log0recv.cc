...
MetadataRecover *recv_recovery_from_checkpoint_finish(bool aborting) {
  ...
  /* Wait for LRU batches currently in progress (dispatched by the LRU
  manager threads) to finish. Note that BUF_FLUSH_LIST batches are awaited
  to finish before we get here. */
