...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM("PRIVACY_POLICY", PRIVACY_POLICY)},
    ...
    */
    ...
    {SYM_H("RANGE_JOIN", RANGE_JOIN_HINT)},
    {SYM_H("NO_RANGE_JOIN", NO_RANGE_JOIN_HINT)}};
