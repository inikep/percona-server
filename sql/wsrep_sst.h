...
#define WSREP_SST_OPT_PLUGIN_DIR "--plugin-dir"
...
#define WSREP_SST_OPT_LOCAL_GTID  "--local-gtid"
#define WSREP_SST_OPT_SERVER_ID   "--server-id"
...
#define WSREP_SST_XTRABACKUPV2 "xtrabackup-v2"
