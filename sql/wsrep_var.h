...
extern bool  wsrep_local_gtid_check          CHECK_ARGS;
extern bool  wsrep_local_gtid_update         UPDATE_ARGS;
extern const char* wsrep_local_gtid_read     READ_ARGS;
