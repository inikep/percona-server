...
STATS_PERSISTENT=0 CHARACTER SET utf8mb3 COLLATE utf8mb3_bin ROW_FORMAT=DYNAMIC
...
-- Create slow_log
CREATE TABLE IF NOT EXISTS slow_log (start_time TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), user_host MEDIUMTEXT NOT NULL, query_time TIME(6) NOT NULL, lock_time TIME(6) NOT NULL, rows_sent INTEGER NOT NULL, rows_examined INTEGER NOT NULL, db VARCHAR(512) NOT NULL, last_insert_id INTEGER NOT NULL, insert_id INTEGER NOT NULL, server_id INTEGER UNSIGNED NOT NULL, sql_text MEDIUMBLOB NOT NULL, thread_id BIGINT UNSIGNED NOT NULL, cpu_usage TIME(6) NOT NULL, delay_total TIME(6) NOT NULL, wait_stats MEDIUMTEXT NOT NULL) engine=CSV CHARACTER SET utf8mb3 comment="Slow log";
